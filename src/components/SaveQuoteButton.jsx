...
export default function SaveQuoteButton({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const payload = {
        quoteName: quoteName.trim(),               // API expects camelCase
  ...
  return (
    <>
      <button
        ...
        disabled={disabled}
        onMouseOver={(e) => { if (!disabled) e.currentTarget.style.backgroundColor = "#4b5563"; }}
        onMouseOut={(e) => { if (!disabled) e.currentTarget.style.backgroundColor = "black"; }}
        ...
        >
          ...
          >
            {status === "success" ? (
              ...
              <div>
                <div className="mb-3">
                  <div className="text-lg font-semibold">Project saved successfully</div>
                  <p className="text-sm text-gray-600 mt-1">
                    {savedInfo?.quote_name
                      ? <>“<strong>{savedInfo.quote_name}</strong>”</>
                      : "Your Project"}
                    {" "}has been saved{savedInfo?.quote_id ? <> as <strong>#{savedInfo.quote_id}</strong></> : ""}.
                  </p>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. East entrance canopy"
                  value={quoteName}
                ...
                <div className="flex justify-end gap-2 mt-2">
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: "0.375rem",
                      color: "white",
                      backgroundColor: saving ? "#6b7280" : "black",
                      fontSize: "0.875rem",
                    }}
                    onClick={handleSave}
                    disabled={saving}
